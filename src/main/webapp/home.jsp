...
.bgimg-1 {
	background-image:
		url('https://static.wixstatic.com/media/ea6ac8_08a05b026f654bcdaa60a5164a0da1d0~mv2.jpg/v1/fill/w_924,h_521,al_c,q_85,enc_auto/ea6ac8_08a05b026f654bcdaa60a5164a0da1d0~mv2.jpg');
	min-height: 100%;
}
	...
	<%@ include file="header.jsp"%>
		...
		<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
			<div class="w3-display-middle" style="white-space: nowrap;">
				<span
					class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">WEBSITE
					<span class="w3-hide-small">UNDER</span> CONSTRUCTION !!!
				</span>
		...
		<div class="w3-content w3-container w3-padding-64" id="about">
			...
			<div class="w3-row">
				<div class="w3-col m6 w3-center w3-padding-large">
					...
					<br> <img
						src="https://i.pinimg.com/564x/22/9b/e1/229be1b487c1d5d871d9d787dacf569e.jpg"
						class="w3-round w3-image w3-opacity w3-hover-opacity-off"
						alt="Photo of Me" width="200" height="200">
				</div>
